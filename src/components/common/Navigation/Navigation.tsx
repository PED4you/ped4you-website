...
export const Navigation = () => {
  ...
  return (
    <nav className="w-full bg-PED-purple py-2 px-6">
      <motion.div
        initial={{ x: -500 }}
        animate={{ x: show ? 0 : -500 }}
        transition={{ type: "tween" }}
        className="fixed top-0 left-0 z-[99] min-h-screen bg-PED-purple lg:hidden"
      >
        ...
        <div className="text-lg text-white">
          <Link href={"/"}>
            <div className={classnames("py-3 px-5", pathname === "/" && "bg-PED-purple-secondary")}>หน้าแรก</div>
          </Link>
          <Link href={"/simulator"}>
          ...
          <Link
            ...
            href={"/#infos"}
          >
            <div className="py-3 px-5">สิ่งที่ควรรู้</div>
          </Link>
          <Link href={"/blog"}>
          ...
          <Link
            ...
            href={"/#about-us"}
          >
            <div className="py-3 px-5">About Us</div>
          </Link>
        </div>
      </motion.div>
      {show && (
        <div
          ...
          className="fixed top-0 left-0 z-[98] min-h-screen w-full"
        />
      )}
      <div className="max-w-desktop mx-auto flex w-full items-center justify-between">
        ...
        <div className="hidden items-center space-x-8 text-lg text-white lg:flex">
          <Link href="/simulator">ลองเลือกตั้ง</Link>
          <a href="/#infos">สิ่งที่ควรรู้</a>
          <Link href="/blog">เกี่ยวกับการเลือกตั้ง</Link>
