...
export const ArticleCard:FC<ArticleCardProps> = (props) => {
  ...
  return <div className="p-2 md:p-4">
    <div className="w-[172px] rounded-2xl border-[3px] border-black pl-2 pt-2 pb-1 text-PED-orange md:w-[252px] md:p-2 md:px-3 md:pt-3">
      {
        // TODO Image handler
      }
      <div className="h-[150px] w-[150px] rounded-xl bg-PED-orange md:h-[222px] md:w-[222px]"/>
