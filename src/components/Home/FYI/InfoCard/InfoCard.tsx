...
export const InfoCard: FC<InfoCardProps> = (props) => {
  ...
  return <div className="p-2 md:p-4">
    <div className={classnames("w-[180px] rounded-2xl border-[3px] border-black px-2 pt-3 pb-4 md:w-[259px] md:px-6 md:pb-5", isInverted ? "bg-PED-purple text-white" : "bg-white text-PED-purple")}>
      {typeof title === "string" ? <h1 className="text-center text-lg md:text-2xl">{title}</h1> : title}
      <div className="relative mt-2 flex justify-center md:mt-4">
        ...
        {isChecked && <div className="absolute -top-2.5 left-0 flex w-full justify-center">
