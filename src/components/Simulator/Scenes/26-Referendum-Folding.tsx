      ...
      <div className="mt-2 flex flex-col items-center gap-6">
        ...
        <div className="grid grid-cols-1 gap-12 sm:grid-cols-2">
          <AnimatePresence key={step}>
            ...
            >
              {step === 1 && <Image src="/images/simulator/folding/step-1r.png" alt="step-1" width={240} height={300} />}
              {step === 2 && <Image src="/images/simulator/folding/step-2r.png" alt="step-1" width={380} height={300} />}
              {step === 3 && <Image src="/images/simulator/folding/step-3r.png" alt="step-1" width={240} height={200} />}
            </motion.div>
          </AnimatePresence>
