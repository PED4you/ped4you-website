        ...
        <div className="grid grid-cols-1 gap-12 sm:grid-cols-2">
          <AnimatePresence key={step}>
            ...
            >
              ...
              {step === 2 && <Image src="/images/simulator/folding/step-2.png" alt="step-1" width={300} height={300} />}
              {step === 3 && <Image src="/images/simulator/folding/step-3.png" alt="step-1" width={300} height={200} />}
            </motion.div>
          </AnimatePresence>
