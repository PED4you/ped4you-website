...
export default function ReferendumEligibility() {
  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center gap-12 p-4">
      <div className="flex flex-col gap-6">
        ...
        >
          คุณ{!canVote && "ยังไม่"}มีสิทธิ์ลงประชามติ !
        </h1>
        ...
        >
          {canVote ? (
            ...
            <>แต่คุณยังสามารถลองลงประชามติกับพวกเราได้นะ !</>
          )}
        </p>

        <div className="flex justify-center">
          <Button className="mx-auto" text="ไปดูบอร์ดกัน !" onClick={() => setPage("18")} />
        </div>
      </div>
      ...
      <div className="absolute bottom-4 mx-auto w-full max-w-sm rounded-xl bg-PED-yellow px-10 py-6 text-center text-base font-light text-PED-purple-secondary md:relative md:mt-10">
        <p className="">
          สามารถตรวจสอบข้อมูลผู้มีสิทธิ์ลงประชามติได้ที่เว็บไซต์ของกรมการปกครอง
          <br />
          <a
