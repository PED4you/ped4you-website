  ...
  return (
    <>
      <div className="flex items-center justify-center border border-black bg-black p-2 text-white">
        <p className="text-center text-2xl font-semibold">{party.no}</p>
      </div>
  ...
  return (
    <section className="relative mx-auto flex min-h-screen w-full max-w-xl flex-col gap-4 overflow-hidden p-4 px-6">
      ...
      >
        ...
        <div className="grid max-h-96 grid-cols-6 gap-2 overflow-y-auto px-4">
        ...
        <div className="flex w-full items-center justify-center gap-6 bg-[#FC60A8] p-6 px-4 text-white">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="flex size-12 items-center justify-center border border-black bg-white p-2 text-black transition-colors duration-500 ease-out hover:bg-PED-orange-secondary"
            ></button>
          </div>
        </div>
      </div>
