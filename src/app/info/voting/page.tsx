...
const Page = () => {
  ...
  return <InfoTemplate namespace={"voting"} title={"การลงคะแนน ?"} primeImgDescription={"วิธีการลงคะแนน"}>
    ...
    <br/><br/>
    <Bold>ปากกาที่ใช้</Bold><br/>
    ใช้ปากกา<Highlight>สีใดก็ได้</Highlight> ไม่นับว่าเป็นบัตรเสีย
    (ที่หน่วยเลือกตั้งส่วนมากจะมีปากกาให้ แต่พกไปเองดีที่สุด)
  </InfoTemplate>
}
