  ...
  return (
    <div className="mx-auto w-full max-w-[752px] py-16">
      ...
      <p className="mb-4 mt-8 px-4 font-light">
        ...
        ยังเปิดโอกาสให้ประชาชนมีส่วนร่วมทางการเมืองเพิ่มขึ้นอีกหนึ่งรูปแบบ คือ การลงคะแนนเสียงใน &ldquo;ประชามติ&rdquo;
        ซึ่งเป็นกลไกสำคัญในการสะท้อนเจตจำนงของประชาชนต่อประเด็นเชิงนโยบายและโครงสร้างทางการเมืองของประเทศโดยตรง
        <br />
        <br />
        <span className="text-lg font-medium">ประชา + มติ</span>
        <br />
        <br />
        ประชา → ประชาชน
        <br />
        ...
        <br />
        <br />
        <span className="text-lg font-medium">ทำไมถึงประชามติรัฐธรรมนูญฉบับใหม่ ?</span>
        <br />
        <br />
        ...
        <br />
        <br />
        <span className="rounded bg-PED-yellow px-2 py-1 font-medium text-PED-purple">Fun Fact:</span>{" "}
        มีการเสนอให้แก้รัฐธรรมนูญรายมาตรามาแล้วถึง 26 ครั้ง แต่ในจำนวนนั้น 25 ครั้งถูกปัดตก
        <br />
        <br />
