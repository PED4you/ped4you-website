...
const Page = () => {
  return <div className="mx-auto w-full max-w-[752px] py-16">
    ...
    <p className="mt-8 mb-4 px-4 font-light">
      ...
      พรรคที่มีเศษมากที่สุดได้เพิ่ม 1 คน เรียงลำดับจนครบ 100 คน
      <br/><br/>
      <span className="font-medium">กล่าวโดยง่าย คือ ได้จำนวน ส.ส. ตามเปอร์เซ็นต์ของพรรคที่ได้</span>
      <br/><br/>
      นั่นคือ นำคะแนนรวมทุกพรรคมาหาร 100 ตัวเลขที่ได้นั้น คือจำนวนเสียงที่ต้องได้ ต่อ ส.ส. บัญชีรายชื่อ 1 คน<br/>
    ...
    <p className="mt-8 mb-4 px-4 font-light">
      ...
      <br/><br/>
      พรรค A ได้ ส.ส. 43 คน<br/>
      พรรค B ได้ ส.ส. 27 คน<br/>
      พรรค C ได้ ส.ส. 19 คน<br/>
      พรรค D ได้ ส.ส. 6 คน<br/>
      พรรค E ได้ ส.ส. 1 คน<br/>
      พรรค F ได้ ส.ส. 1 คน<br/>
      พรรค G ได้ ส.ส. 0 คน
      <br/><br/>
      *หลังจากคำนวณตามสูตรแล้ว ได้ ส.ส. บัญชีรายชื่อ 97 คน ยังเหลือที่นั่งว่างอีก 3 ที่ ซึ่งจะนำคิดตามข้อ 3 โดยการเรียงเลขทศนิยมของทุกพรรคจากมากไปน้อย
      <br/><br/>
      <span className="font-medium">พรรค A xx.7333 ได้ ส.ส. เพิ่ม รวมเป็น 44 คน</span><br/>
      พรรค B xx.3333<br/>
      <span className="font-medium">พรรค C xx.6000 ได้ ส.ส. เพิ่ม รวมเป็น 20 คน</span><br/>
      <span className="font-medium">พรรค D xx.6667 ได้ ส.ส. เพิ่ม รวมเป็น 7 คน<br/></span>
      พรรค E xx.2000<br/>
      พรรค F xx.0667<br/>
      พรรค G xx.4000
      <br/><br/>
      ...
      <br/><br/>
      <span className="font-medium">สรุปจำนวน ส.ส.</span><br/>
      พรรค A 44 คน<br/>
      พรรค B 27 คน<br/>
      พรรค C 20 คน<br/>
      พรรค D 7 คน<br/>
